...
#undef BB_RSHELL_SESSION_POLICY
...
#undef BB_COMMAND_QUEUE_ENABLE
#undef BB_COMMAND_QUEUE_PORT
#undef BB_COMMAND_QUEUE_TLS
#undef BB_COMMAND_QUEUE_REQUIRE_TOKEN
#undef BB_COMMAND_QUEUE_TOKEN_SOURCE
#undef BB_COMMAND_QUEUE_TOKEN
#undef BB_COMMAND_QUEUE_ALLOWED_COMMANDS
#undef BB_COMMAND_QUEUE_EXECUTION
#undef BB_COMMAND_QUEUE_ALLOW_ARBITRARY
#undef BB_COMMAND_QUEUE_POLL_INTERVAL_SEC
#undef BB_COMMAND_QUEUE_POLL_JITTER_PCT
#undef BB_COMMAND_QUEUE_POLL_BACKOFF
#undef BB_COMMAND_QUEUE_POLL_MAX_INTERVAL_SEC
#undef BB_COMMAND_QUEUE_MAX_POLLS
...
#define BB_RSHELL_SESSION_POLICY bb_config_get("BB_RSHELL_SESSION_POLICY")
...
#define BB_COMMAND_QUEUE_ENABLE bb_config_get("BB_COMMAND_QUEUE_ENABLE")
#define BB_COMMAND_QUEUE_PORT bb_config_get("BB_COMMAND_QUEUE_PORT")
#define BB_COMMAND_QUEUE_TLS bb_config_get("BB_COMMAND_QUEUE_TLS")
#define BB_COMMAND_QUEUE_REQUIRE_TOKEN bb_config_get("BB_COMMAND_QUEUE_REQUIRE_TOKEN")
#define BB_COMMAND_QUEUE_TOKEN_SOURCE bb_config_get("BB_COMMAND_QUEUE_TOKEN_SOURCE")
#define BB_COMMAND_QUEUE_TOKEN bb_config_get("BB_COMMAND_QUEUE_TOKEN")
#define BB_COMMAND_QUEUE_ALLOWED_COMMANDS bb_config_get("BB_COMMAND_QUEUE_ALLOWED_COMMANDS")
#define BB_COMMAND_QUEUE_EXECUTION bb_config_get("BB_COMMAND_QUEUE_EXECUTION")
#define BB_COMMAND_QUEUE_ALLOW_ARBITRARY bb_config_get("BB_COMMAND_QUEUE_ALLOW_ARBITRARY")
#define BB_COMMAND_QUEUE_POLL_INTERVAL_SEC bb_config_get("BB_COMMAND_QUEUE_POLL_INTERVAL_SEC")
#define BB_COMMAND_QUEUE_POLL_JITTER_PCT bb_config_get("BB_COMMAND_QUEUE_POLL_JITTER_PCT")
#define BB_COMMAND_QUEUE_POLL_BACKOFF bb_config_get("BB_COMMAND_QUEUE_POLL_BACKOFF")
#define BB_COMMAND_QUEUE_POLL_MAX_INTERVAL_SEC bb_config_get("BB_COMMAND_QUEUE_POLL_MAX_INTERVAL_SEC")
#define BB_COMMAND_QUEUE_MAX_POLLS bb_config_get("BB_COMMAND_QUEUE_MAX_POLLS")
