...
int applet_config_info_main(int argc, char **argv)
{
    ...
    printf("compiled_zero_arg_mode=%s\n", bb_config_compiled("GRIT_ZERO_ARG_MODE"));
    printf("compiled_noresidue_level=%s\n", bb_config_compiled("GRIT_NORESIDUE_LEVEL"));
    printf("compiled_rshell_transport=%s\n", bb_config_compiled("GRIT_RSHELL_TRANSPORT"));
    printf("compiled_rshell_session_policy=%s\n", bb_config_compiled("GRIT_RSHELL_SESSION_POLICY"));
    printf("compiled_rshell_operator_host=%s\n", bb_config_compiled("GRIT_OPERATOR_SERVER_HOST"));
    printf("compiled_command_queue_enable=%s\n", bb_config_compiled("GRIT_COMMAND_QUEUE_ENABLE"));
    printf("compiled_command_queue_require_token=%s\n", bb_config_compiled("GRIT_COMMAND_QUEUE_REQUIRE_TOKEN"));
    printf("compiled_command_queue_token_source=%s\n", bb_config_compiled("GRIT_COMMAND_QUEUE_TOKEN_SOURCE"));
    printf("compiled_command_queue_token_configured=%s\n", bb_config_compiled("GRIT_COMMAND_QUEUE_TOKEN")[0] ? "yes" : "no");
    printf("compiled_command_queue_allowed_commands=%s\n", bb_config_compiled("GRIT_COMMAND_QUEUE_ALLOWED_COMMANDS"));
    printf("compiled_command_queue_execution=%s\n", bb_config_compiled("GRIT_COMMAND_QUEUE_EXECUTION"));
    printf("compiled_command_queue_allow_arbitrary=%s\n", bb_config_compiled("GRIT_COMMAND_QUEUE_ALLOW_ARBITRARY"));
    printf("compiled_command_queue_poll_interval_sec=%s\n", bb_config_compiled("GRIT_COMMAND_QUEUE_POLL_INTERVAL_SEC"));
    printf("compiled_command_queue_poll_jitter_pct=%s\n", bb_config_compiled("GRIT_COMMAND_QUEUE_POLL_JITTER_PCT"));
    printf("compiled_command_queue_poll_backoff=%s\n", bb_config_compiled("GRIT_COMMAND_QUEUE_POLL_BACKOFF"));
    printf("compiled_command_queue_poll_max_interval_sec=%s\n", bb_config_compiled("GRIT_COMMAND_QUEUE_POLL_MAX_INTERVAL_SEC"));
    printf("compiled_command_queue_max_polls=%s\n", bb_config_compiled("GRIT_COMMAND_QUEUE_MAX_POLLS"));
