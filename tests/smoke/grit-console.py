...
def run_line_console_smoke(server, tmp, upload_cfg, session_root):
    ...
    route_context_help_start = line_console_stdout.find("grit[all]/route/console-route> ?", route_context_start + 1)
    route_context_help_end = line_console_stdout.find("grit[all]/route/console-route> options", route_context_help_start + 1)
    route_context_help_text = (
