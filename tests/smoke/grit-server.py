...
def run_line_console_smoke(server, tmp, upload_cfg, session_root):
    ...
    line_console_required_markers = [
        ...
        "Help: queue",
        "Help: events",
        "Route model: listen locally on LPORT, forward to DEST_HOST:DEST_PORT.",
        "Single hop target-to-operator SSH: route add ssh-home 2222 127.0.0.1 22 target:2222=operator:22",
        "Multi-hop example: route add web-hop 8080 192.168.1.1 80 target:8080=jump:9001 jump:9001=operator:80",
