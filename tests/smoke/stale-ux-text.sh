...
require_text Makefile '^unit-test: unit-test-console'
require_text Makefile '^unit-test-console:'
require_text Makefile '^unit-test-qemu: test-qemu-user test-qemu-system test-qemu-flaky-network'
require_text Makefile '^unit-test-all: unit-test-console unit-test-qemu'
