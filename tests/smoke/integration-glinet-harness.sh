...
printf '%s\n' "$repo_release_json" | python3 -c 'import json,sys; d=json.load(sys.stdin); s=d["command_record_summary"]; assert s["stage_kind_counts"]["release-artifact"] == 1; assert s["compatibility_label_counts"]["exact"] == 1'
