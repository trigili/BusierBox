...
$bringup_primary --host root@192.0.2.1 --recommend-only --survey-json tests/fixtures/survey/glinet-mt7621.json >/dev/null
bringup_out=$($bringup_primary --host root@192.0.2.1 --recommend-only --survey-json tests/fixtures/survey/glinet-mt7621.json --target-preset glinet-mt7621-openwrt-musl)
...
bringup_json=$($bringup_primary --recommend-only --survey-json tests/fixtures/survey/glinet-mt7621.json --write-target-preset smoke-bringup --stage-recommended-artifact --operator-host 198.51.100.9 --target-id bringup-alpha --target-label "Bringup Router" --target-alias lab-bringup --configure-trailer --json)
...
JSON
repo_release_json=$($bringup_primary --recommend-only --survey-json tests/fixtures/survey/glinet-mt7621.json --reality-json "$release_repo_tmp/reality.json" --release-dir "$release_repo_tmp/releases" --stage-recommended-artifact --json)
