...
SRC := src/busierbox.c src/applet_payload.c src/applet_extract.c src/applet_list.c src/applet_manifest.c src/applet_doctor.c src/applet_config_info.c src/applet_clean.c src/applet_plan.c src/applet_recovery.c src/applet_survey.c src/applet_envfix.c src/applet_fetch.c src/ledger.c src/runtime_paths.c src/runtime_probe.c src/json_helpers.c src/payload_extract.c src/payload_dispatch.c
