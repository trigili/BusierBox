...
SRC := src/busierbox.c src/applet_payload.c src/applet_clean.c src/applet_recovery.c src/applet_survey.c src/applet_envfix.c src/ledger.c src/json_helpers.c
