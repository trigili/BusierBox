...
ux-audit-console:
	@tests/usability/console-ux-audit.py
...
smoke-test:
	...
	$(call run_if_python3,tests/smoke/compatibility-matrix.sh,python3 compatibility matrix smoke unavailable)
