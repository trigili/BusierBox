...
LINE_COMMAND_HELP_TOPICS = {
    ...
    "listeners": {
        ...
        "entries": [
            ...
            ("listener probe config [N]", "generate config from the most recent or numbered probe result"),
            ("listener probe config write-config FILE", "generate and save config from probe data"),
            ("listener probe serve [start]", "stage the matching binary from the release for this arch"),
