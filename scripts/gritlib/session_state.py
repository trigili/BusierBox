...
class SessionManager:
    ...
    def _recent_metadata_record(self, path, metadata_path, events_path, session_log_path, meta):
    ...
    def _recent_legacy_record(self, path, metadata_path, events_path, session_log_path):
        session_log_exists = session_log_path.is_file()
        exit_reason = ""
        try:
    ...
    def recent_records(self, cfg, limit=8):
        ...
        for path in self.recent_paths(cfg, limit):
            ...
            if isinstance(meta, dict) and meta:
                out.append(self._recent_metadata_record(path, metadata_path, events_path, session_log_path, meta))
                continue
            out.append(self._recent_legacy_record(path, metadata_path, events_path, session_log_path))
        return out
