...
def _resolve_legacy_search_route_callbacks(
    use_result_func,
    bridge_command_builder,
    start_service_func,
    stop_service_func,
...
def _resolve_legacy_file_target_callbacks(
    view_path_func,
    scoped_target_cfg_func,
    print_target_summary_func,
    file_callbacks,
...
def _resolve_legacy_action_callbacks(
    actions_func,
...
def _build_resolved_line_legacy_dispatch(
    cfg,
    input_func,
    clear_results_func,
    sleep_func,
    ...
    return build_line_legacy_dispatch_callback(
        cfg,
        input_func=input_func,
        use_result_func=route_resolved["use_result_func"],
        clear_results_func=clear_results_func,
        start_service_func=route_resolved["start_service_func"],
        stop_service_func=route_resolved["stop_service_func"],
        ...
        service_rows_func=route_resolved["service_rows_func"],
        service_record_func=route_resolved["service_record_func"],
        sleep_func=sleep_func,
        append_event_fn=append_event_fn,
        print_staged_func=print_staged_func,
        snapshot_func=snapshot_func,
        view_path_func=target_resolved["view_path_func"],
        stage_binary_func=file_callbacks["stage_binary"],
        actions_func=action_resolved["actions_func"],
        run_workbench_action_func=action_resolved["run_workbench_action_func"],
        run_target_workflow_func=action_resolved["run_target_workflow_func"],
        scoped_target_cfg_func=target_resolved["scoped_target_cfg_func"],
        print_target_summary_func=target_resolved["print_target_summary_func"],
        bridge_command_builder=route_resolved["bridge_command_builder"],
        print_bridge_profile_func=route_resolved["print_bridge_profile_func"],
        delete_bridge_profile_func=route_resolved["delete_bridge_profile_func"],
        action_state_text_func=action_resolved["action_state_text_func"],
...
def build_line_legacy_callbacks(
    ...
    *,
    ...
    route_resolved = _resolve_legacy_search_route_callbacks(
        use_result_func,
        bridge_command_builder,
        start_service_func,
        stop_service_func,
    ...
    target_resolved = _resolve_legacy_file_target_callbacks(
        view_path_func,
        scoped_target_cfg_func,
        print_target_summary_func,
        file_callbacks,
    ...
    action_resolved = _resolve_legacy_action_callbacks(
        actions_func,
        run_workbench_action_func,
        run_target_workflow_func,
        action_state_text_func,
    ...
    return {"dispatch_line_legacy": _build_resolved_line_legacy_dispatch(
        cfg,
        input_func,
        clear_results_func,
        sleep_func,
