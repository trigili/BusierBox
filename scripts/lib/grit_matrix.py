#!/usr/bin/env python3
"""Shared matrix helpers for griTTYkit build and mirror tooling."""
...
def write_config(path, target, payload, fmt, variant=None):
    ...
    lines = [
        text.rstrip(),
        "",
        "# generated by griTTYkit matrix tooling",
        f"GRIT_TARGET_PRESET={shell_quote(target)}",
        f"GRIT_PAYLOAD_PRESET={shell_quote(payload)}",
